...
(function () {
  ...
  function showIosInstallModal() {
    ...
    modal.innerHTML = `
      ...
      <div role="dialog" aria-modal="true" style="position:relative;background:var(--card-bg);padding:16px;border-radius:10px;max-width:420px;width:92%;box-shadow:0 10px 30px var(--shadow)">
